...
class StPosMonitor(BasicMonitor):
    ...
    def __init__(self, mainEngine, eventEngine, parent=None):
        ...
        d['actleg'] = {'chinese':u'主动腿持仓', 'cellType':BasicCell}
        d['actlegPos'] = {'chinese':u'主动腿盈亏', 'cellType':PnlCell}
        d['passleg'] = {'chinese':u'被动腿持仓', 'cellType':BasicCell}
        d['passlegPos'] = {'chinese':u'被动腿盈亏', 'cellType':PnlCell}
